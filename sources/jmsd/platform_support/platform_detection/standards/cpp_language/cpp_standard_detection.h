...
#define JMSD_CPLUSPLUS17_VERSION_CONSTANT		201703L
...
#if defined( JMSD_MICROSOFT_VISUAL_CPP_COMPILER_IS_DETECTED ) && ( JMSD_COMPILER_VERSION < JMSD_MICROSOFT_VISUAL_CPP_COMPILER_VERSION_1916_VS2017 )
